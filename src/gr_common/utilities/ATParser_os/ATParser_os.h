 ...
 *
 */
#ifndef AT_PARSER_OS_H
#define AT_PARSER_OS_H
...
* @code
* ATParser_os at = ATParser_os(serial, "\r\n");
* int value;
* char buffer[100];
*
...
public:
    ...
    */
    ATParser_os(BufferedSerial &serial, const char *delimiter = "\r\n", int buffer_size = 256, int timeout = 8000, bool debug = false) :
        _serial(&serial),
    ...
    */
    ...
    /**
    * Get timeout to be changed between commands
    *
    * @return timeout timeout of the connection
    */
    int getTimeout() {
        return _timeout;
    }
