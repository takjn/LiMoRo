 ...
 * @ingroup drivers
 */
class mSPI : private NonCopyable<mSPI> {
...
public:
     ...
     */
    mSPI(PinName mosi, PinName miso, PinName sclk, PinName ssel=NC);
...
private:
    ...
    */
    ...
    static CircularBuffer<Transaction<mSPI>, TRANSACTION_QUEUE_SIZE_SPI> _transaction_buffer;
#endif
