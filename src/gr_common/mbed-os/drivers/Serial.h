 ...
 * @ingroup drivers
 */
class mSerial : public SerialBase, public mStream, private NonCopyable<mSerial> {
...
public:
     ...
     */
    mSerial(PinName tx, PinName rx, const char *name=NULL, int baud = MBED_CONF_PLATFORM_DEFAULT_SERIAL_BAUD_RATE);
     ...
     *    Either tx or rx may be specified as NC if unused
     */
    mSerial(PinName tx, PinName rx, int baud);
